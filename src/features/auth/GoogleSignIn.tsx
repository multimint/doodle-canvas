...
export function GoogleSignIn() {
  ...
  return (
    <div className="min-h-screen paper-dots flex items-center justify-center p-6">
      ...
      <div className="absolute top-8 left-8 text-muted text-4xl font-hand select-none hidden md:block">
        ✏️
      </div>
      <div className="absolute bottom-10 right-10 text-muted text-3xl font-hand select-none hidden md:block rotate-12">
        ✦
      </div>
      ...
      >
        ...
        {error && (
          <p className="font-body text-accent text-sm mt-1">{error}</p>
        )}
