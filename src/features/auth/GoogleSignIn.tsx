...
import { Icon, GoogleG, MCOLORS } from '../../lib/icons'
...
/* ---------- Stage: parallax root ---------- */
function Stage({ children, compact }: { children?: React.ReactNode; compact?: boolean }) {
...
/* ---------- SignInPanel ---------- */
function SignInPanel({ onSignIn, onGuest, guestLoading, error, compact = false, sheet = false }: {
